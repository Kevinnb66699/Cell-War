...
MAP = {
    ...
    "SOLIDIFY_THRESHOLD_BY_STAGE": ["计数到达3时**癌组织**转为**固化癌组织**",
                                   "【固化】所需的固化计数降低为2", "【固化】所需的固化计数降低为1.5"],
    ...
    "PROLIFERATE_BASE_BY_STAGE": ["r_{增生概率}=3%+0.5%times所有相邻癌性组织联通块中固化癌组织数",
                                  ...
                                  "r_{增生概率}=5%+1.5%times所有相邻癌性组织联通块中固化癌组织数"],
    # ---- 特殊组织 ----
    ...
    "ANAEROBIC_STAGE_MUL_BY_STAGE": ["【无氧呼吸】在基础数值上增益20%", "【无氧呼吸】在基础数值上增益50%"],
