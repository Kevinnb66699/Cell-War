...
##
## 第一版取癌组织贴图那块红提亮一档（#E05A6E @0x6E），叠完 #C55163 —— 偏粉。Kevin 2026-09-19
## 「癌性组织上方的滤镜太淡了，稍微加深一点」，看过艳红 / 深绯几档之后定的是
## **「把最原版的红色稍微加深一点就行了」**：同一家红、少一点粉（G / B 压下去）、比例抬到 0x8C ≈ 0.55
## 让它不比第一版更淡 —— #D8364F，叠完 #C63F54（第一版 #C55163；与未高亮癌格 0.10、
## 与健康候选格 0.73、与攻击橙叠色 0.22）。候选帧见 `截图_2026-09-19_issue47_加深/`。
const MARK_MOVE_SICK := Color("d8364f8c")
