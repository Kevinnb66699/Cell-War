...
# PRD【I-免疫记忆】：III 级「迁移到癌性组织的耗能降为 **0.8**」（2026-09-09 由 0.7 改）；
# X 级「迁移耗能均改为 0.5」。
# ⚠ **X 级那条 2026-09-09 的新文本里没再提**，团队只给了 I/II/III/X 四段里 III 的 0.8。
#   这里**保持 0.5 不动**：删掉是个很大的平衡改动，不该靠「新文本没写」来推断。
#   等团队确认 X 级到底还减不减（已在开发日志里标出）。
...
const IMMUNE_MOVE_CANCEROUS := [10, 10, 8, 5] # 迁移→癌性，按等级 I/II/III/X
