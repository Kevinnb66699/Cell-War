...
## 【S-有氧呼吸】2026-09-07 Kevin 换公式：**(等级系数 − 1)² × 0.5 + 2**，等级系数 I/II/III/X = 1/2/3/4。
## 引擎的 immune_level 是 0 起，所以就是 base + step × 等级²：2.0 / 2.5 / 4.0 / 6.5。
## 与 09-05 方案 f 的区别：基数不再按人数分档（那张表退为 abase=-1 对照档），且等级项**平方**了。
