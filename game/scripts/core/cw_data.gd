...
# **PRD 2026-09-12 覆盖版**：指数也按人数分档（四人 0.3 / 六人 0.35），整式外面套 max{2, …} ——
...
## 指数按人数分档（PRD 2026-09-12）：四人 0.30、六人 0.35；2 人局同系数那条的道理，沿用缺省
const ANAEROBIC_BLOCK_EXP_BY_PLAYERS := { 2: 30, 4: 30, 6: 35 }
...
## 按人数取无氧指数（PRD 2026-09-12：四人 0.3 / 六人 0.35）。表里没有的人数退回缺省。
