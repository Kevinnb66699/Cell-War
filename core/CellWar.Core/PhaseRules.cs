...
internal static class PhaseRules
{
    ...
    public static RulesResult AdvancePhase(WorldState s, IDeterministicRng rng)
    {
        ...
        else if (s.Turn.Phase == Phase.PlayerAction)
        {
            ...
            s = s.WithTurn(s.Turn.WithPendingChain(null).WithPendingChemotaxis(null, 0).WithPendingCouple(null, null, null).WithPendingCard(null, null).WithPendingRemodel(null, null, null, 0).WithPendingLand(null, null, 0).WithPendingMarrow(Array.Empty<HexPosition>(), 0));
