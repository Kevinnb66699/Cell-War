...
public static class CanonCodec
{
    public static CanonState To(WorldState s) => new()
    {
        ...
        G = new CanonGlobal(s.Turn.WorldRound, (int)s.Turn.Phase, s.Turn.ActivePlayerSeat,
            ...
            s.Turn.StartStep, s.Turn.Winner is { } w ? (int)w : null, s.Turn.CancerWinStreak,
            ...
            s.Turn.PendingCouplePayer is { } cp3 ? Seat(cp3) : null)
        {
            ...
            PendingPickCellSeat = s.Turn.PendingPickCellSeat, PendingPickCellCard = s.Turn.PendingPickCellCard ?? "",
            PendingPickCellChooser = s.Turn.PendingPickCellChooser is { } ppc ? Seat(ppc) : null,
    ...
    public static WorldState From(CanonState c)
    {
        ...
        return new WorldState
        {
            ...
            Turn = new TurnState
            {
                ...
                WinKind = c.G.WinKind,
                CancerWinStreak = c.G.CancerWinStreak,
                ...
                PendingPickCellSeat = c.G.PendingPickCellSeat,
                PendingPickCellCard = c.G.PendingPickCellCard == "" ? null : c.G.PendingPickCellCard,
                PendingPickCellChooser = c.G.PendingPickCellChooser is { } ppc ? Id(ppc) : null,
